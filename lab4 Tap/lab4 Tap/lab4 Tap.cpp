...
Fractie& Fractie::operator=(const Fractie& other) {
    if (this != &other) { // Evitarea autoatribuirii
...
int main() {
    // Exemplu de utilizare a clasei Fractie și operatorilor suprascriși
    Fractie fractie1(2, 3);
    Fractie fractie2(4, 6);
    ...
    if (fractie1 < fractie2) {
        std::cout << "Fractie 1 este mai mica decat Fractie 2." << std::endl;
    }
    else if (fractie1 > fractie2) {
        std::cout << "Fractie 1 este mai mare decat Fractie 2." << std::endl;
    }
    else {
